...
const Shop = () => {
    ...
    return (
    <>
    <div class="container" style={{alignItems:"center",marginTop:"10%",display:"flex",justifyContent:"space-evenly"}}>
      <Card  style={{ width: '18rem' , borderWidth:1,  borderStyle:"solid"}}>
       <Card.Img variant="top" src={IMG} style={{width:"100%"}} />
       <Card.Body style={{ textAlign:"center"}}>
       <Card.Title style={{color:"Red"}}>Kashmiri HandCrafts</Card.Title>
       <Card.Text>
         Responsibilities: Design beautiful kashmir style HandCrafts<br/>
         Location: Bangalore<br/>
         Date posted: 1 Oct,2021<br/>
         Contact: kashmirhandcrafts@gmail.com
      </Card.Text>
     <Button variant="primary" style={{backgroundColor:"#44A7F7",color:"white"}}>Apply</Button>
      </Card.Body>
     </Card>
